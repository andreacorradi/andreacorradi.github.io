...
$nomeprogetto['it'] = "Officine Meccaniche Capitanio";
$nomeprogetto['en'] = "Officine Meccaniche Capitanio";

include ("andrea-header.php"); ?>

  <!-- Page Title -->
  <section class="page-title page-title-banner page-title-image-parallax space-bottom-3x" style="background-image:url(img/portfolio/omc/omc-header.gif);">
    <div class="container">
  ...
  <section class="section-fw">
    <div class="container-singlework-grid">
      <img src="img/portfolio/omc/letters.jpg" class="block-center" alt="">
    </div>
  </section>
  ...
  <section class="section-split bg-solid-white">
    <div class="column-singlework-grid2">
      <img data-src="img/portfolio/omc/4punte1.jpg" class="lazyload" alt=""><noscript><img src="img/portfolio/omc/4punte1.jpg" /></noscript>
    </div>
    <div class="column-singlework-grid2">
      <img data-src="img/portfolio/omc/4punte1v.png" class="lazyload" alt=""><noscript><img src="img/portfolio/omc/4punte1v.png" /></noscript>
    </div>
  </section>
  ...
  <section class="section-split">
    <div class="column-singlework-grid2">
      <img data-src="img/portfolio/omc/4punte2v.png" class="lazyload" alt=""><noscript><img src="img/portfolio/omc/4punte2v.png" /></noscript>
    </div>
    <div class="column-singlework-grid2">
      <img data-src="img/portfolio/omc/4punte2.jpg" class="lazyload" alt=""><noscript><img src="img/portfolio/omc/4punte2.jpg" /></noscript>
    </div>
  </section>
  ...
  <section class="section-fw">
    <div class="container-singlework-grid">
      <img data-src="img/portfolio/omc/cards.jpg" class="block-center lazyload" alt=""><noscript><img src="img/portfolio/omc/cards.jpg" class="block-center" /></noscript>
    </div>
  </section>
  ...
  <section class="section-fw">
    <div class="container-singlework-grid">
      <img data-src="img/portfolio/omc/letterandcard.jpg" class="block-center lazyload" alt=""><noscript><img src="img/portfolio/omc/letterandcard.jpg" class="block-center" /></noscript>
    </div>
  </section>
  ...
  <section class="section-fw">
    <div class="container-singlework-grid">
      <img data-src="img/portfolio/omc/home-pezzo2.gif" class="block-center lazyload" alt=""><noscript><img src="img/portfolio/omc/home-pezzo2.gif" class="block-center" /></noscript>
    </div>
  </section>
  ...
  <section class="container space-top-3x padding-bottom-2x">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center">
        <blockquote>
          <p>The website is built using a custom WordPress theme I created on top of the Thematic framework theme.</p>
          <!-- <footer>C.E.R.A. Rapone</footer> -->
        </blockquote>
      </div>
    </div>
  ...
  <section class="section-fw">
    <div class="container-singlework-grid">
      <img data-src="img/portfolio/omc/website-home.jpg" class="block-center lazyload" alt=""><noscript><img src="img/portfolio/omc/website-home.jpg" class="block-center" /></noscript>
    </div>
  </section>
  ...
  <section class="section-fw">
    <div class="container-singlework-grid">
      <img data-src="img/portfolio/omc/website-products.jpg" class="block-center lazyload" alt=""><noscript><img src="img/portfolio/omc/website-products.jpg" class="block-center" /></noscript>
    </div>
  </section>
